...
1. Takes Verilog File to be parsed as a ommand line arguement
...
FUTURE IMPROVEMENTS
 ...
 Aim is to make it possible to derive the same results when following style of declaartion is used in RTL code:
     	   input x, y, z;
